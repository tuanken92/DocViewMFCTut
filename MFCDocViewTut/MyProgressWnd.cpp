...
BOOL CMyProgressWnd::Create(CWnd* pParent, LPCTSTR pszTitle, BOOL bSmooth /* = TRUE */)
{
	...
	//ncm.cbSize = sizeof(NONCLIENTMETRICS);	// 윈도우 버전에서 Visual Studio 버전 구분으로 변경함 - 2014.04.22 최석원

	/************************************************************************/
	/*　　MS VC++ 12.0 _MSC_VER = 1800 (VC2013)*/
	/*　　MS VC++ 11.0 _MSC_VER = 1700 (VC2012)*/
	/*　　MS VC++ 10.0 _MSC_VER = 1600 (VC2010)*/
	/*　　MS VC++ 9.0 _MSC_VER = 1500 (VC2008)*/
	/*　　MS VC++ 8.0 _MSC_VER = 1400 (VC2005)*/
	/*　　MS VC++ 7.1 _MSC_VER = 1310 (VC2003)*/
	/*　　MS VC++ 7.0 _MSC_VER = 1300 (.NET)*/
	/*　　MS VC++ 6.0 _MSC_VER = 1200 */
	/*　　MS VC++ 5.0 _MSC_VER = 1100 */
	/*　　MS VC++ 4.x _MSC_VER = 1000 */
	/************************************************************************/
#if _MSC_VER == 1200
	// VC6.0
	...
	// 윈도우 버전에서 Visual Studio 버전 구분으로 변경함 - 2014.04.22 최석원
/*
#if(WINVER >= 0x0600)
...
int CMyProgressWnd::SetPos(int nPos)                    
{
    ...
    if (nPercentage != m_nPrevPercent) 
    {
        ...
        strTitle.Format(_T("%s [%d%%]"), m_strTitle.GetString(), nPercentage);
...
void CMyProgressWnd::SetText(LPCTSTR fmt, ...)
{
    ...
    va_start(args, fmt);
    _vstprintf_s(buffer, 511, fmt, args);
    va_end(args);
